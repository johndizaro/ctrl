...
class User(pydantic.BaseModel):
    username: str
    password: str
    age: int = Field(title="titulo do campo", description="descrição do campo")
    score: float
    email: Optional[str]
    ...
    def password_valid(cls, value):
        ...
        raise ValueError(
            " Password deverá conter ao menos uma caracter esspecial,número, letra minúscula e letra maiúscula")
