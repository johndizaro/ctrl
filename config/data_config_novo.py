...
class DataConfig:
    ...
    # config_caminho: Optional[str] = field(init=False, default=os.path.dirname(os.path.abspath(os.curdir)))
    # config_caminho: Optional[str] = field(init=False, default= os.path.abspath(os.curdir))

    # config_nome_arquivo: Optional[str] = field(init=False, default="config.ini")
